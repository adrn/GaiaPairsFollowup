...
\todo{Gaia will help \gaia\ (\cite{Gaia-Collaboration:2016,Gaia-Collaboration:2016a})}
...
typically not possible to determine whether these systems are in fact bound.
...
\project{Hipparcos} mission (\citealt{hipparcos?}) and the \gaia\ mission
...
through radial velocity follow-up of candidate comoving stars discovered from
their astrometry alone (\citealt{Oh:2017}).
