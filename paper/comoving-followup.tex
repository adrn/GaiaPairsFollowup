...
a significant velocity offset at ${\rm H}\alpha$ of $\approx 25$--$100~\kms$.
...
As mentioned previously, comparison lamp spectra were not obtained at each
telescope pointing.
Depending primarily on the hour angle of the observation (because of the orientation of the spectrograph and CCD), there
