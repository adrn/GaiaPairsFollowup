...
find an abundance of pairs at separations $\gtrsim 1~\pc$.
...
\subsubsection{Radial velocity measurement}
...
abundance differences between coeval stars (e.g., \citealt{yo}, Oh et al.,
submitted).
...
\todo{Reiterate that monotonically decreasing separation distribution is too
simple}
