...
observation because of the physical orientation of the spectrograph and CCD as
mounted on the telescope.
To correct each sourcce spectrum for this offset, we measure the centroids of
...
$5577.XXX~{\rm \AA}$ and $6300.XXX~{\rm \AA}$ respectively, then convert these
wavelength offsets to pixel offsets.
We take the mean of the pixel offsets
...
TODO: line measurements, model, gaussian process
  - per-spectrum precisions ~5-10 km/s
