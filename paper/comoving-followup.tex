...
pairs.
% Results
Of the \npairsobs\ observed comoving pairs, \nhighprob\ comoving pairs have
probabilities $50\%$ with separations as large as $\approx 10~\pc$, our original
search limit.
...
uniform.
% Conclusions
We thus confirm the discovery of a population of comoving star pairs at very
large separations, suggesting that disrupted wide binaries and stellar
associations remain approximately spatially coherent.
% \todo{something about stellar models and chemical tagging?}
\end{abstract}
...
commonly done---too simple to also represent the population of unbound systems.
