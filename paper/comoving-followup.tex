...
\begin{figure}[htbp]
  ...
  \caption{%
    ...
    \emph{Right}: Distribution of sky separations of all comoving star pairs
    (gray) and only those identified as genuinely comoving (black).
...
\todo{Highlight a binary sequence-main sequence pair}
\todo{Highlight the largest mag difference MS pair}
...
Abundances - future work, Coronado in prep.!
