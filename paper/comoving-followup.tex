...
\figurename~\ref{fig:wavelength-GP} shows an example of one such fit with the
best-fit linear polynomial subtracted from the (pixel-centroid, wavelength)
pairs (black points) and fit curve (darker line).
