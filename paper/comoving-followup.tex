...
We compile Tycho 2 ($B$, $V$; \citealt{derp}), 2MASS ($J$, $H$, $K_{\rm s}$;
\citealt{derp}), and WISE ($W_1$, $W_2$, $W_3$; \citealt{derp}) photometry for
each star in the pairs below and fit isochrones to the stars individually to
measure their stellar parameters.
