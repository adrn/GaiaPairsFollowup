...
\subsection{Physical properties of genuine comoving pairs}\label{sec:separation}
...
stars.
Small, grey markers are pairs for which $\llrnew < \llrold$, i.e. where the
...
background, grey histogram shows all observed pairs, and foreground, black
