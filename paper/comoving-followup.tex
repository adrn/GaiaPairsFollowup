...
implemented in \package{emcee} (\citealt{Foreman-Mackey:2013}).
...
(\acronym{RAVE}; \citealt{Kunder:2017})---202 pairs.
...
\todo{however, hard to get 2 stars with same 3d velocities}
