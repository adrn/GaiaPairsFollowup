...
\begin{figure}[htbp]
  ...
  \end{center}
  \caption{%
    Color-magnitude diagram for all \tgas\ sources within $200~\pc$ (blue
    histogram) and all comoving star pair members observed in this follow-up
    effort (black points); lines (orange) connect comoving pairs of stars.
