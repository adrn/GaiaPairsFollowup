...
massive perturbers in the Galaxy, i.e. giant molecular clouds (GMCs), black holes, etc. (\citealt{Weinberg:1987}).
...
Oelkers:2017, Andrews:2017}) have been discovered over the last several decades (see also \citealt{Chaname:2007} and references therein).
...
as ``comoving pair candidates'' --- or using full-space velocity information --- we refer to these as ``comoving pairs.''
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=\linewidth]{highlighted_cmd.pdf}
  \end{center}
  \caption{%
...
HD 95088 HD 92278
Angular sep.: 4.49 deg
Chord length: 8.66 pc
3D sep.: 9.53 pc
parallaxes: 9.00 +/- 0.50, 9.32 +/- 0.51

This pair is separated by $8.7~\pc$ in chord length ($4.5^\circ$ on the sky) and
have consistent distances within their uncertainties of $\approx 110~\pc$.
From visual classification of the stars' location in the color--magnitude
diagram (\figurename~\ref{fig:highlighted-cmd}), the pair appears to be
comprised of an A-type dwarf and a slightly less massive G-type subgiant.
If this is indeed the case, the two stars could therefore not be coeval, as the
...
Other possibilities stem from the possibility that the comoving pair is the
outcome of an interaction between more stars.
...
These explanations are all speculative at the moment; high-resolution
spectroscopy of these stars --- and precise measurements of the stellar
parameters and chemical abundances --- may help to distinguish these
possibilities.

\subsubsection{HD 79247 -- TYC 3807-1439-1}

This pair is separated by $XX~\pc$ in chord length ($XX^\circ$ on the sky) and
have consistent distances within their uncertainties of $\approx XX~\pc$.
From visual classification of the stars' location in the color--magnitude
diagram (\figurename~\ref{fig:highlighted-cmd}), the pair appears to be
comprised of a G-type subgiant and a G-type dwarf.

\subsubsection{HD 54318 -- TYC 3792-658-1}

TYC 3792-658-1 HD 54318
Angular sep.: 2.51 deg
Chord length: 8.45 pc
3D sep.: 8.73 pc
parallaxes: 5.20 +/- 0.23, 5.30 +/- 0.32

This pair is separated by $8.5~\pc$ in chord length ($2.5^\circ$ on the sky) and
have consistent distances within their uncertainties of $\approx 190~\pc$.

From visual classification of the stars' location in the color--magnitude
diagram (\figurename~\ref{fig:highlighted-cmd}), the pair appears to be
comprised of a late-A-/early-B-type dwarf and a G-type dwarf.
...
Caution about selection criteria, false-positives at large separation...
