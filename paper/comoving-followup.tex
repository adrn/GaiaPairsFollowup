...
mass perturbation spectrum of the Milky Way.
% Aims
...
From the smallest separation pairs, $\approx 10^{-3}~\pc$, out to $\approx
0.5~\pc$, we find that the number of confirmed comoving star pairs decreases
with increasing separation, as expected.
From $\approx 0.5~\pc$ to $10~\pc$, the separation distribution appears
