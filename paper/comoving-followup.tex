...
line using a constant offset + Gaussian process (GP) with a Mat\'ern 3/2 kernel
...
likelihood, and maximize the (log-)likelihood again using \lbfgsb\
optimization.
...
additional, unknown constant offset of, typically, $\approx 0.5$--$2~{\rm
\AA}$, corresponding to a significant velocity offset at ${\rm H}\alpha$ of
$\approx 20$--$100~\kms$.
